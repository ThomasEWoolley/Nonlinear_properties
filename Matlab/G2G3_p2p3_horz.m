...
axis equal
axis([0 5 -5 5])
export_fig('../Pictures/DG2G3_horz.png','-r300')
% 
%%
% close all
figure
...
for i=1:length(G3y)
    p2_eval=p2v(G2x,G3y(i));
    p3_eval=p3v(G2x,G3y(i));

    surf([p2_eval;p2_eval],[p3_eval;p3_eval],[G2x;G2x],'facecol','no',...
        'edgecol','interp',...
        'linew',2,'linestyle',sty{i});

end
colormap('copper')
export_fig('../Pictures/p2p3_horz.png','-r300')